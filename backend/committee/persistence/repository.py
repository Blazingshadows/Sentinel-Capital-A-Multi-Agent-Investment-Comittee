...
def insert_decision_log(session: Session, log: DecisionLog) -> int:
    row = models.Decision(
        ...
        risk_expected_return=log.risk_verdict.expected_return,
        risk_expected_drawdown=log.risk_verdict.expected_drawdown,
        alternatives=[a.model_dump(mode="json") for a in log.consensus.alternatives],
